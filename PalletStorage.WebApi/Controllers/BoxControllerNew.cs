...
[ApiController]
public class BoxControllerNew : ControllerBase
{
    //private readonly IBoxRepository repo;
    private readonly BoxCommonController commonController;

    // constructor injects repository registered in Startup
    public BoxControllerNew(BoxCommonController commonController)
    {
    ...
    {
        return (IEnumerable<BoxApiModel>)await commonController.GetBoxes();
    }
